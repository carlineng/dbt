...
from typing import (
    Generic, TypeVar, Dict, Any, Tuple, Optional, List, Union, Sequence
)

from dbt.clients.jinja import get_rendered
from dbt.contracts.graph.unparsed import (
    UnparsedNodeUpdate, UnparsedSourceDefinition,
    UnparsedSourceTableDefinition, HasTests, UnparsedMacroUpdate,
...
class SourceTarget:
    ...
    @property
    def columns(self) -> Sequence[HasTests]:
...
class SchemaTestBlock(TestBlock[Testable], Generic[Testable]):
    ...
    @classmethod
    def from_test_block(
        cls, src: TestBlock, test: Dict[str, Any], column_name: Optional[str]
    ) -> 'SchemaTestBlock':
        return cls(
            file=src.file,
            data=src.data,
